...
! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).Sweetalert2 = t() }(this, (function() { "use strict"; const e = {},
    ...
    ve.text = ve.email = ve.password = ve.number = ve.tel = ve.url = (e, t) => (we(e, t.inputValue), be(e, e, t), fe(e, t), e.type = t.input, e), ve.file = (e, t) => (be(e, e, t), fe(e, t), e), ve.range = (e, t) => { const o = e.querySelector("input"),
        ...
        Be = (e, t) => { if (!t.icon) return; let o, n = e.innerHTML; if (t.iconHtml) o = $e(t.iconHtml);
            ...
            n.trim() !== o.trim() && D(e, o) },
        Ee = (e, t) => { if (t.iconColor) { e.style.color = t.iconColor, e.style.borderColor = t.iconColor; for (const o of[".swal2-success-line-tip", ".swal2-success-line-long", ".swal2-x-mark-line-left", ".swal2-x-mark-line-right"]) Z(e, o, "backgroundColor", t.iconColor);
        ...
        Le = (e, t) => {
            ((e, t) => { const o = f(),
                    ...
                    W(n, "padding", t.padding), t.color && (n.style.color = t.color), t.background && (n.style.background = t.background), Y(E()), xe(n, t) } })(0, t), de(0, t), ((e, t) => { const o = B(); if (!o) return; const { progressSteps: n, currentProgressStep: s } = t;
        ...
        Ne = e => { const t = [$(), P(), x()]; if (document.activeElement instanceof HTMLElement && !t.includes(document.activeElement)) return; const o = Ie.includes(e) ? "nextElementSibling" : "previousElementSibling"; let n = document.activeElement; for (let e = 0; e < L().children.length; e++) { if (n = n[o], !n) return; if (n instanceof HTMLButtonElement && X(n)) break }
    ...
    function et(e) { const t = _e.swalPromiseReject.get(this);
        ...
        Ct = (e, t) => { const n = o.innerParams.get(e || void 0); if (n.showLoaderOnConfirm && rt(), n.preConfirm) { e.resetValidationMessage(), e.isAwaitingPromise = !0;
                Promise.resolve().then((() => g(n.preConfirm(t, n.validationMessage)))).then((o => { X(E()) || !1 === o ? (e.hideLoading(), tt(e)) : wt(e, void 0 === o ? t : o) })).catch((t => vt(e || void 0, t))) } else wt(e, t) };
    ...
    function Et(e, t, n) { const i = o.domCache.get(e);
    ...
    function xt() { Et(this, ["confirmButton", "denyButton", "cancelButton"], !1) }

    function Pt() { Et(this, ["confirmButton", "denyButton", "cancelButton"], !0) }
    ...
    class To { constructor() { if ("undefined" == typeof window) return;
        ...
        Oo = e => { const t = { popup: w(), container: f(), actions: L(), confirmButton: $(), denyButton: P(), cancelButton: x(), loader: T(), closeButton: M(), validationMessage: E(), progressSteps: B() }; return o.domCache.set(e, t), t },
        Mo = (e, t, o) => { const n = O();
