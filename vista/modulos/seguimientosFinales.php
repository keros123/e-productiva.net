...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Asignación de seguimientos /</span> Seguimientos finales
    </h4>

    <div class="row seguimientosPorTipo" id="seguimientosPorTipo" tipo="Final">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="error"></div>
